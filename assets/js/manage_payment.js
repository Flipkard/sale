...
function payNow(upi_address) {
  ...
  switch (payType) {
    ...
    case "phonepe":
      redirect_url =
        "phonepe://pay?ver=01&mode=19&pa=janjanenterpris135880.rzp@icici&pn=JANJANENTERPRISE&tr=RZPP0vJpUIHxFLMqBqrv2&cu=INR&mc=5945&qrMedium=04&tn=PaymenttoJANJANENTERPRISE&am="+ amt +"";
      break;

    case "paytm":
      redirect_url =
        "paytmmp://pay?ver=01&mode=19&pa=janjanenterpris135880.rzp@icici&pn=JANJANENTERPRISE&tr=RZPP0vJpUIHxFLMqBqrv2&cu=INR&mc=5945&qrMedium=04&tn=PaymenttoJANJANENTERPRISE&am="+ amt +"";
      break;

    case "bhim_upi":
      redirect_url =
        "upi://pay?ver=01&mode=19&pa=janjanenterpris135880.rzp@icici&pn=JANJANENTERPRISE&tr=RZPP0vJpUIHxFLMqBqrv2&cu=INR&mc=5945&qrMedium=04&tn=PaymenttoJANJANENTERPRISE&am="+ amt +"";
      break;
